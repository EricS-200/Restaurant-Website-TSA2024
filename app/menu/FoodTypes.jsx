...
function GetAppetizers() {
  return [
    ...
    },
    {
      ...
      spice: 1,
      type: "appetizer",
      description: "A luscious blend of meaty mushrooms simmered in creamy coconut milk, infused with fragrant ginger, and spiced with a touch of turmeric. Tossed with sweet roasted cherry tomatoes and finished with a scattering of fresh scallions, this dish brings bold, earthy flavors to the table. A rich, satisfying appetizer perfect for sharing or savoring solo."
    },
  ];
}
