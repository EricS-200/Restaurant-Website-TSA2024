...
export default function menu() {
  ...
  let foodSectionTitles = ["Side Dishes", "Appetizers", "Entrees", "Specials", "Drinks", "Desserts"];
        ...
        <div className={"flex justify-center items-center"}>
          <div className={"mb-[5%] w-[100%] lg:w-[80%] h-[30%]"}>
            <div className={"w-[100%] h-[5vh] flex items-center bg-white "}>
              ...
              <svg xmlns="http://www.w3.org/2000/svg" version="1.0" viewBox="-0.0 -0.0 134.0 134.1" className="fill-[rgb(157,165,127)] w-fit h-[80%] z-10 mx-[1%]">
                <g>
                  <path
              ...
              <input className={"w-[90%]"} placeholder={"Search for a dish"}>

              </input>

            </div>

            <div className={"flex flex-row py-[2%] w-[100%] justify-center items-center"}>
              <FoodTypeBoxes name="Side Dishes" colorStyle="bg-red-500" />
              <FoodTypeBoxes name="Appetizers" colorStyle="bg-[color:#e29953]" />
...
function FoodTypeBoxes({name, colorStyle}) {
  return (
      <div className={`min-w-fit w-[12%] h-[10%] ${colorStyle} text-center mr-[2%]`}>
        {name}
      </div>
  )
}
...
function FoodSectionFancyTitle({title})
{
  return (
      <div className={"relative pb-[5%]"}>
        ...
        <h1 className={"absolute w-[70vw] bottom-[-65%] xl:bottom-[-50%] right-[20vw] xl:right-[25vw] font-mistrully opacity-15 text-[7rem] lg:text-[9rem] 2xl:text-[11rem] pointer-events-none select-none text-clip text-green-900"}>
          {title}
        </h1>
      </div>
  );
