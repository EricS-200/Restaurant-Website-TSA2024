...
export default function Menu() {
  // Retrieve dish arrays from helper functions
  ...
  // Determine whether to show titles:
  // On mobile (< 640px) titles are hidden when a search query is active.
  const showTitle = !(isMobile && searchQuery.trim() !== "");

  return (
    <main className="bg-gradient-to-b from-[#4c5a2b] to-[#64642b] relative overflow-x-clip">
      <Overlay
        scrollY={scrollY}
